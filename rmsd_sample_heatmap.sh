...
plot_RMSD_heatmap_dir="${plot_dir}"/RMSD/heatmap
...
create_dir_if_not_exists "$plot_RMSD_heatmap_dir"
...
python /home/duanqi/dq/scripts/rmsd_sample_heatmap.py "${pdb_file}" "${af_file}" "${frame_number}" "${group_number}" "${min_interval}" "${max_interval}" "${num_intervals}" "${plot_RMSD_heatmap_dir}" "${save_time}"
