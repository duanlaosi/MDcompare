...
plot_PCA_MANOVA_dir="${plot_PCA_dir}"/MANOVA
...
create_dir_if_not_exists "$plot_PCA_MANOVA_dir"
#set environment
...
python /home/duanqi/dq/scripts/sample_MANOVA.py "${pdb_file}" "${af_file}" "${min_interval}" "${max_interval}" "${num_intervals}" "${plot_PCA_MANOVA_dir}" "${save_time}"
