...
af_secondary_structure_dir=""${af_analysis_dir}"/Secondary_structure"
...
pdb_secondary_structure_dir=""${pdb_analysis_dir}"/Secondary_structure"
...
create_dir_if_not_exists "$pdb_secondary_structure_dir"
create_dir_if_not_exists "$af_secondary_structure_dir"
...
##make secondary structure for pdb

#make image for pdb structure
echo "Making movie for pdb trajectory..."
bash /home/duanqi/dq/scripts/secondary_structure.py "$pdb_gro_file" "$pdb_secondary_structure_dir" "$af_gro_file" "$af_secondary_structure_dir"
#make image for af structure
echo "Making movie for af trajectory..."
bash /home/duanqi/dq/scripts/secondary_structure.tcl "$af_gro_file" "$af_secondary_structure_dir" "$af_color_ID"
