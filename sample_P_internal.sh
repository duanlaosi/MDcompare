...
python /home/duanqi/dq/scripts/sample_P_internal.py "${pdb_file}" "${af_file}" "${frame_number}" "${group_number}" "${min_interval}" "${max_interval}" "${num_intervals}" "${plot_PCA_P_internal_dir}" "${save_time}"
