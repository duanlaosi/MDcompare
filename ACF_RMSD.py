        ...
        for line in file:
            ...
            if len(parts) >= 2:
                try:
                    ...
                    raise ValueError(f"cannot read xvg:cannot change '{parts[0]}' or '{parts[1]}' into float \n wrong line:{line.strip()}") from e 
...
def main():
   ...
   #------------------------------------------------------------------------------------------# 
    ...
    plt.title("Autocorrelation of PDB RMSD")
    plt.grid()
    plt.show()
    #------------------------------------------------------------------------------------------------------#
    data = af_RMSD
    ...
    plt.plot(acf[:300])
    plt.ylabel("Autocorrelation")
    plt.title("Autocorrelation of AF RMSD")
    plt.grid()
    plt.show()
