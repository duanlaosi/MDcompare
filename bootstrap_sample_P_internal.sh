...
plot_PCA_P_internal_dir="${plot_PCA_dir}"/P_internal
plot_P_internal_bootstrap_dir="${plot_PCA_P_internal_dir}"/bootstrap
...
create_dir_if_not_exists "$plot_PCA_P_internal_dir"
create_dir_if_not_exists "$plot_P_internal_bootstrap_dir"
#define xvg files
...
# plot bootstrap sample p-value
# python /home/duanqi/dq/scripts/bootstrap_sample_P_internal.py "${pdb_file}" "${af_file}" "${frame_number}" "${group_number}" "${min_interval}" "${max_interval}" "${num_intervals}" "${plot_P_internal_bootstrap_dir}" "${save_time}"
# plot bootstrap sample p-value with FDR and distribution
python /home/duanqi/dq/scripts/bootstrap_fdr_P_internal.py "${pdb_file}" "${af_file}" "${frame_number}" "${group_number}" "${min_interval}" "${max_interval}" "${num_intervals}" "${plot_P_internal_bootstrap_dir}" "${save_time}"
