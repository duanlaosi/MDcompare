...
def main():
    ...
    for i, sample_interval in enumerate(sample_intervals):
        ...
        pdb_sample_frame_number = len(pdb_sample_PC1)
        af_sample_frame_number = len(af_sample_PC1)

        # Create groups for PDB and AF data
        pdb_grouped_data = create_groups(pdb_sample_PC1, pdb_sample_frame_number, args.group_number, "PDB")
        af_grouped_data = create_groups(af_sample_PC1, af_sample_frame_number, args.group_number, "AF")
