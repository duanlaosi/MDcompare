...
def parse_arguments():
    ...
    parser.add_argument('--end_interval', type=float, default=1.0,
                        help='Ending sample interval in ns (default: 1.0)')
    
    parser.add_argument('--interval_steps', type=int, default=9,
                        help='Number of interval steps between start and end (default: 9)')
