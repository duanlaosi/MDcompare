...
plot_PCA_distribution_dir="${plot_PCA_dir}"/distribution
...
create_dir_if_not_exists "$plot_PCA_distribution_dir"
...
python /home/duanqi/dq/scripts/proj_distribution_1D2traj.py "${pdb_file}" "${af_file}" "${plot_PCA_distribution_dir}" "${save_time}"
